...
export default class ReviewApplication extends Component {
    ...
    render() {
        const loans = [{label: 'First Loan', value: 'fLoan'}, {
            label: 'Second Loan',
            value: 'sLoan'
        }, {label: 'Third Loan', value: 'tLoan'}]
                ...
                >
                    ...
                    <View style={styles.bottomNavigationView}>
                        <View style={{flex: 1}}>
                            ...
                            <View
                                style={[theme.container, styles.MainContainer, styles.header, {marginVertical: scaleHeight(20)}]}>
                            ...
                            <View style={{flex: 9}}>
                                <KeyboardAwareScrollView keyboardShouldPersistTaps={'handled'} enableOnAndroid={true}
                                                         scrollEnabled={true} alwaysBounceVertical={false}
                                                         bounces={false}>
                                    <View style={[theme.container, styles.MainContainer]}>
                                        <View style={{
                                            ...
                                            <View style={{flex: 2, flexDirection: 'column'}}>
                                                <Text style={[theme.caption, theme.flex1, theme.padded_label]}>Loan
                                                    Type</Text>
                                                <View
                                                    style={[styles.pickerStlye, {borderWidth: StyleSheet.hairlineWidth}]}>
                                                    <Picker
                                                        ...
                                                        {ids.map((item, index) => <Picker.Item key={index}
                                                                                               label={item.label}
                                                                                               value={item.value}/>)}
                                                    </Picker>
                                                </View>
                                            ...
                                            <View style={{flex: 1, justifyContent: 'flex-end', marginLeft: 12}}>
                                                <Text style={[theme.caption, theme.flex1, theme.padded_label]}>Interest
                                                    Rate</Text>
                                                <View style={[theme.typo_bold, theme.font17]}>
                                                    <Text style={[theme.font15, {
                                                        color: '#138516',
                                        ...
                                        }]}>For this Loan type, you would require a guarantor</Text>
                                        <View style={{
                                            flexDirection: 'row',
                                            alignItems: 'flex-start',
                                            ...
                                            <View style={{flex: 2, flexDirection: 'column', marginRight: 12}}>
                                                <Text
                                                    style={[theme.caption, theme.flex1, theme.padded_label]}>Amount</Text>
                                                <View
                                                    style={[styles.pickerStlye, {borderWidth: StyleSheet.hairlineWidth}]}>
                                    ...
                                    <View style={[theme.container, styles.MainContainer]}>
                                        <Text style={[theme.typo_regular, {
                                            ...
                                            justifyContent: 'space-between',
                                            marginVertical: scaleHeight(20)
                                        }]}>At least Two guarantor is needed.</Text>
                                        <View style={{
                                            flexDirection: 'row',
                                            alignItems: 'flex-start',
                                            marginBottom: scaleHeight(30)
                                        ...
                                        <View style={[styles.buttons]}>
                                            ...
                                            <TouchableOpacity activeOpacity={0.7} style={[styles.link]}
                                                              onPress={() => this.toggleApplication}>
