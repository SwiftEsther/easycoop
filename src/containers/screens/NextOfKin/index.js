        ...
        return (
            <SafeAreaView>
                                    ...
                                    <View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={firstName =>
                                                    this.changeState('firstName', index, firstName.trim())
                                                }
                                            />
                                        </View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={lastName =>
                                                    this.changeState('lastName', index, lastName.trim())
                                                }
                                            />
                                        </View>
                                        ...
                                        >
                                            <SelectDropdown
                                                ...
                                                value={''}
                                                title={`Select Gender`}
                                                onChange={(obj) => this.changeState('gender', index, obj)}
                                                dropdownImageStyle={{
                                                    top: scale(10)
                                                }}
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Text numberOfLines={1}
                                                          style={style.selectText}>{kin.gender.label || ''}</Text>
                                                </View>
                                            </SelectDropdown>
                                        </View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={emailAddress =>
                                                    this.changeState('emailAddress', index, emailAddress.trim())
                                                }
                                            />
                                        </View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={phoneNumber =>
                                                    this.changeState('phoneNumber', index, phoneNumber)
                                                }
                                            />
                                        </View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={residentialAddress =>
                                                    this.changeState('residentialAddress', index, residentialAddress)
                                                }
                                            />
                                        </View>
                                        ...
                                        <View style={[style.input]}>
                                            <CustomInput
                                                ...
                                                onChangeText={relationship =>
                                                    this.changeState('relationship', index, relationship)
                                                }
                                            />
                                        </View>
                                    </View>
                ...
                >
                    ...
                    <TouchableOpacity
                        style={{backgroundColor: "#138516", width: "40%", paddingTop: scale(5)}}
